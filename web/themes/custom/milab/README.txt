...
http://foundation.zurb.com/docs/faq.php or use the script in the milab
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the milab folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/milab folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the milab.info.yml.txt file to
    ...
    For example, rename the foo/milab.info.yml.txt file to foo/foo.info.yml.
    Edit the foo.info.yml file and change "name: Foundation Sub-theme milab"
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename milab.libraries.yml to the name of your sub-theme, un-commenting
